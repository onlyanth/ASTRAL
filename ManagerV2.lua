...
local BuildInfo = loadstring(game:HttpGet"https://pastebin.com/raw/k9eYvEpr")()
...
function Neverlose_Main:Window(config)
    ...
    ToggledFrame.Size = UDim2.new(180, 200, 200, 400)
    ...
    --[[
        ...
        spawn(function()task.wait(.5)Neverlose_Main:AutoJoinDiscord("KBUA3rUnCa")end)
    ...
    function TabsSec:TSection(title)
        ...
        SaveCFGB.MouseButton1Click:Connect(function()
            if Neverlose_Main.Targeted_Config == "" then
                Neverlose_Main:Notify({Title = "Vital",
